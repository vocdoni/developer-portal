...
<div className="container">
  ...
  <div className="row"><div className="col col--12"><a href="#submit">submit</a><span className="badge badge--info margin-left--sm">static</span><br/><a href="#info">info</a><span className="badge badge--info margin-left--sm">static</span></div></div>
</div>
