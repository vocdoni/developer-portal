...
<div className="container">
  ...
  <div className="row"><div className="col col--12"><a href="#generateWalletFromData">generateWalletFromData</a><span className="badge badge--info margin-left--sm">static</span><br/><a href="#setElectionId">setElectionId</a><br/><a href="#fetchChainId">fetchChainId</a><br/><a href="#fetchAccountInfo">fetchAccountInfo</a><br/><a href="#calculateCID">calculateCID</a><br/><a href="#fetchFaucetPayload">fetchFaucetPayload</a><br/><a href="#parseFaucetPackage">parseFaucetPackage</a><br/><a href="#fetchAccountToken">fetchAccountToken</a><br/><a href="#fetchElection">fetchElection</a><br/><a href="#waitForTransaction">waitForTransaction</a><br/><a href="#fetchProof">fetchProof</a><br/><a href="#fetchProofForWallet">fetchProofForWallet</a><br/><a href="#setAccountInfo">setAccountInfo</a><br/><a href="#createAccount">createAccount</a><br/><a href="#collectFaucetTokens">collectFaucetTokens</a><br/><a href="#createCensus">createCensus</a><br/><a href="#createElection">createElection</a><br/><a href="#endElection">endElection</a><br/><a href="#pauseElection">pauseElection</a><br/><a href="#cancelElection">cancelElection</a><br/><a href="#continueElection">continueElection</a><br/><a href="#changeElectionStatus">changeElectionStatus</a><br/><a href="#isInCensus">isInCensus</a><br/><a href="#hasAlreadyVoted">hasAlreadyVoted</a><br/><a href="#isAbleToVote">isAbleToVote</a><br/><a href="#votesLeftCount">votesLeftCount</a><br/><a href="#submitVote">submitVote</a></div></div>
</div>
