...
<div className="container">
  ...
  <div className="row"><div className="col col--12"><a href="#info">info</a><span className="badge badge--info margin-left--sm">static</span><br/><a href="#keys">keys</a><span className="badge badge--info margin-left--sm">static</span><br/><a href="#create">create</a><span className="badge badge--info margin-left--sm">static</span><br/><a href="#electionVotesCount">electionVotesCount</a><span className="badge badge--info margin-left--sm">static</span><br/><a href="#electionVotesList">electionVotesList</a><span className="badge badge--info margin-left--sm">static</span></div></div>
</div>
...
### electionVotesCount {#electionVotesCount}
...
### electionVotesList {#electionVotesList}
